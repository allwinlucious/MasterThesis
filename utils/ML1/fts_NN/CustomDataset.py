...
class CustomDatasetFromCSV(Dataset):
    ...
    def __init__(self, csv_path, device="cpu",mode="train"):
        """
        Args:
        ...
        if self.mode == "train":
            ...
            X_max = torch.load("models/X_max.pt")
            X_min = torch.load("models/X_min.pt")
            y_max = torch.load("models/y_max.pt")
            y_min = torch.load("models/y_min.pt")
        else:
